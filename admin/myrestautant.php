...
<div class="col-md-6 bg-danger text-center m-auto"> 
  <a href="food_items/items.php" class="text-white text-decoration-none fs-4 fw-bold px-5">Menu modification</a>
  <a href="food_items/chefdetails.php" class="text-white text-decoration-none fs-4 fw-bold px-5">Chef/Admin Details</a>
</div>
